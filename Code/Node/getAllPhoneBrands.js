...
async function getAllPhoneBrands(req, res) {
    //console.log("Tentative de recuperation des marques de tel");

    brands = await queries.getAllPhoneBrands();
...
module.exports = getAllPhoneBrands;